...
export const MessageIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const DesktopIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TeamIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
