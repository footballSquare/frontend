...
//     );
//     // 제한: minAppear가 4보다 크면 4로 처리 (최종 라운드는 2강으로 간주)
...
//    *********************************************************/
//   const roundOrder = [16, 8, 4, 2]; // 내림차순
...
/**
 * 토너먼트 형식으로 매치 데이터를 변환한다.
 * @param matchList - 실제 매치 정보
 * @param teamList - 팀 정보
 * @param championshipTypeIdx - 토너먼트 시작 라운드를 결정하는 인덱스 (1=16강, 2=8강, 3=4강)
 * @returns TournamentData[]: 각 라운드별 매치 정보를 배열로 반환
 */
const convertToTournamentFormat = (
  matchList: ChampionshipMatchList[],
  teamList: ChampionshipTeamInfo[],
