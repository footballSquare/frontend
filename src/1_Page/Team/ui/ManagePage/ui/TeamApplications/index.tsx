...
const TeamApplications = () => {
  ...
  const handleAccept = (idx: number) => {
    ...
    console.log("Accepted player with idx:", idx);
  };

  const handleReject = (idx: number) => {
    // Implement reject logic
    console.log("Rejected player with idx:", idx);
  };
          ...
          {signMemberList.map((player) => (
            <div
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => handleAccept(player.player_list_idx)}
                ...
                <button
                  onClick={() => handleReject(player.player_list_idx)}
